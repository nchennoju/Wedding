      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className='col-md-7 animate-box'>
            ...
            <p>Our journey took a serendipitous turn with an accidental date at Mendocino Farms, where hours melted away in conversation about our dreams and the thoughtful gifts we had exchanged over the summer. Beach dates and project meetings followed, intertwining our lives as we leaned on each other's strengths to navigate the whirlwind of school, the rocket project, and the burgeoning bond between us.</p>
            ...
            <p>As the school year drew to a close, we faced the daunting task of securing jobs that would keep us together. Despite the distance that threatened to separate us, our love endured, fortified by promises whispered across time zones and flights taken in turn to bridge the gap.</p>
            <p>We both found work in the rocket industry, a testament to our shared dedication and ambition. Yet, the challenge of being apart persisted, testing our resolve with each passing day. But through it all, we held fast to the belief that this separation was temporary, a mere chapter in our story.</p>
            ...
            <h4>And on Dec 29th, 2023, We Said Yes!</h4>
          </div>
        </div>
      </div>
    </div>
