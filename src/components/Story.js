      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className='col-md-7 animate-box'>
            ...
            <h4>Dec 29th, 2023, We Said Yes!</h4>
            <p>
              In the canals of Newport Beach on a Gondola, the big question was asked.Luality fringilla duiman at elit finibus viverra nec a lacus themo
              the druanye sene sollicitudin mi suscipit non sagie the fermen.
            </p>
          </div>
        </div>
